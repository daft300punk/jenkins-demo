...
docker tag hashicorp/http-echo ${REGISTRY}/jenkins-demo-node:3
docker push ${REGISTRY}/jenkins-demo-node:3
docker tag ${REGISTRY}/jenkins-demo-node:3 ${REGISTRY}/jenkins-demo-node:latest
