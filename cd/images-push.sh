...
docker tag ${REGISTRY}/boxboat-blog-dotnet:${TAG} ${REGISTRY}/boxboat/boxboat-blog-dotnet:latest
docker push ${REGISTRY}/boxboat-blog-dotnet:latest
docker push ${REGISTRY}/boxboat-blog-nginx:${TAG}
docker tag ${REGISTRY}/boxboat-blog-nginx:${TAG} ${REGISTRY}/boxboat/boxboat-blog-nginx:latest
docker push ${REGISTRY}/boxboat-blog-nginx:latest
docker push ${REGISTRY}/boxboat-blog-ui-ssr:${TAG}
docker tag ${REGISTRY}/boxboat-blog-ui-ssr:${TAG} ${REGISTRY}/boxboat/boxboat-blog-ui-ssr:latest
